...
const productos= [
    {id:'1', foto: img[3], stock: 30, title:'CREMA FACIAL - PIEL EQUILIBRADA - FORMULA DIA', categoria:'Cremas', text:'Clínica y dermatológicamente testeada.Formulada con aceite de almendras, manteca de mango, aceite de sésamo y extractos botánicos 100% naturales. Contiene agentes hidratantes que balancean la microbiota de la piel, regulan el ph y estimulan los mecanismos de defensa, con un suave aroma a durazno.', precio:'$1600'},
    {id:'2', foto: img[3], stock: 30, title:'CREMA FACIAL - PIEL EQUILIBRADA - FORMULA NOCHE', categoria:'Cremas', text:'Clínica y dermatológicamente testeada.Formulada con aceite de almendras, manteca de mango, aceite de sésamo y extractos botánicos 100% naturales. Contiene agentes hidratantes que balancean la microbiota de la piel, regulan el ph y estimulan los mecanismos de defensa, con un suave aroma a durazno.', precio:'$1600'}, 
    {id:'3', foto: img[3], stock: 30, title:'CREMA PARA ROSTRO - PIEL GRASA - FORMULA DIA', categoria:'Cremas', text:'Clínica y dermatológicamente testeada.Formulada con aceite de ricino, aceite de lino, aceite de sésamo y extractos botánicos 100% naturales.Contiene activos concentrados de Fomes Officinalis (hongo que crece sobre los alerces), aminoácidos, vitaminas del grupo B y un fresco aroma a peonia.', precio:'$1600'},
    {id:'4', foto: img[3], stock: 30, title:'CREMA PARA ROSTRO - PIEL GRASA - FORMULA NOCHE', categoria:'Cremas', text:'Clínica y dermatológicamente testeada.Formulada con aceite de ricino, aceite de lino, aceite de sésamo y extractos botánicos 100% naturales.Contiene activos concentrados de Fomes Officinalis (hongo que crece sobre los alerces), aminoácidos, vitaminas del grupo B y un fresco aroma a peonia.', precio:'$1600'},
    {id:'5', foto: img[1], stock: 30, title:'JABONES VEGETALES - LÍNEA ESENCIAL', categoria:'Jabones', text:'Nuestros JABONES VEGETALES - LINEA ESENCIAL están elaborados con aceite de coco. Limpian e hidratan la piel de manera natural y delicada.', precio:'$420'},
    {id:'6', foto: img[1], stock: 30, title:'JABÓN VEGETAL EXFOLIANTE', categoria:'Jabones', text:'Elaborado con Aceite de Coco y Aceite de Oliva Orgánico, junto a la acción exfoliante de las SEMILLAS DE AMARANTO, deja la piel suave, libre de impurezas.', precio:'$420'}, 
